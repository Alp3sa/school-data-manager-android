package com.gestordedatos.gestordedatos.application;
...
import com.gestordedatos.gestordedatos.volley.Utils.LruBitmapCache;

/**
 * Created by Tiburcio on 13/11/2016.
 */

public class AppController extends Globals {
    ...
    public static final String ACCOUNT_TYPE = "com.gestordedatos.gestordedatos";
    // The account name
    public static final String ACCOUNT = "Manager";
    // Sync interval constants
    public static final long SYNC_INTERVAL = Globals.SYNC_INTERVAL; // Cada 2 minutos
